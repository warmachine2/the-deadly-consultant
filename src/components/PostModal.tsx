  ...
  const wrapIframesInGlass = (html: string): string => {
    ...
    return html.replace(iframeRegex, (match) => {
      ...
      if (src && (src.includes("youtube.com") || src.includes("youtu.be"))) {
        ...
        return `<div class="glass rounded-3xl p-6 mb-6"><div class="relative w-full pb-[56.25%]"><iframe ${attributes} class="absolute top-0 left-0 w-full h-full rounded-2xl" allow="accelerometer