      ...
      <div className="flex items-center justify-between h-16 px-2 xl:px-5 gap-1 xl:gap-2 w-full">
        ...
        <div className="flex items-center gap-1 xl:gap-2 flex-shrink-0">
          ...
          <Link to="/" className="hidden xl:block">
            <div className="flex flex-col items-center px-2 xl:px-3 py-1.5">
              <h1
                className="text-xl xl:text-2xl font-bold text-white cursor-pointer transition-opacity whitespace-nowrap"
              ...
              <span className="text-[10px] xl:text-xs text-white tracking-wide text-center bg-black/70 px-2 py-0.5 rounded mt-0.5">
        ...
        <div className="flex items-center gap-1 flex-shrink-0">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="hidden xl:block px-1.5 xl:px-2 py-2 text-sm font-semibold text-white hover:text-[#F4C903] transition-all duration-300 whitespace-nowrap"
          >
            Training Program
          </a>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                className="hidden xl:flex px-1.5 xl:px-2 py-2 text-sm font-semibold text-white hover:text-[#F4C903] transition-all duration-300 whitespace-nowrap items-center gap-1"
              >
                Articles
          ...
          <Link to="/book-session" className="hidden xl:block">
            <button
              className="px-1.5 xl:px-2 py-2 text-sm font-semibold text-white hover:text-[#F4C903] transition-all duration-300 whitespace-nowrap"
            >
              Book Session
            </button>
          </Link>
          ...
          <Link to="/2026-bi-fintech-consulting-roadmap-pdf-unlock">
            <button
              className="px-2 py-1.5 text-[10px] xl:px-4 xl:py-2 rounded-xl font-semibold xl:text-sm transition-all duration-300 whitespace-nowrap bg-[#DC2626] text-white hover:text-[#F4C903] border border-cyan-400/60 active:scale-95 cta-glow-pulse-red"
