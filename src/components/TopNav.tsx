      ...
      <div className="flex h-16 w-full items-center justify-between gap-2 px-4">
              ...
              <div className="flex flex-col py-4">
                ...
                <div className="px-4">
                  <a href={WORKSHOP_REGISTER_URL} target="_blank" rel="noopener noreferrer" onClick={closeMobileMenu}>
                    <button className="header-workshop-pill w-full px-4 py-3 font-bold text-white">
        ...
        <div className="flex flex-shrink-0 items-center gap-1">
          ...
          <a href={WORKSHOP_REGISTER_URL} target="_blank" rel="noopener noreferrer">
            <button
              className="header-workshop-pill px-2.5 py-1.5 text-[11px] leading-tight text-center whitespace-normal font-bold text-white hover:text-white transition-colors duration-300 max-w-[130px] sm:max-w-none md:px-4 md:py-2.5 md:text-xs 2xl:px-5 2xl:py-3 2xl:text-sm shadow-none"
            >
              Reserve My Free Workshop
            </button>
          </a>
