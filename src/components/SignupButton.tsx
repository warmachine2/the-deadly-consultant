  ...
  return (
    <>
      <button
        ...
        className="relative inline-flex items-center justify-center px-10 py-4 font-bold text-xl whitespace-nowrap transition-all duration-300 ease-in-out hover:scale-105 active:scale-95 cursor-pointer overflow-hidden group rounded-2xl bg-accent text-accent-foreground border-2 border-border hover:animate-glow-pulse hover:shadow-[0_0_30px_hsla(0,0%,100%,0.4)]"
      >
